    ...
    return (
        <main className="min-h-screen text-foreground relative z-10 pt-32 pb-24">
            <div className="max-w-350 mx-auto px-6">
                {/* Hero */}
                <div className="text-center mb-20 max-w-4xl mx-auto bg-white/70 dark:bg-black/75 rounded-3xl shadow-2xl border border-white/50 dark:border-white/10 p-12 transition-colors duration-700">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-slate-900 dark:text-white mb-6 transition-colors duration-700">
                        Architecting the{' '}
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-600 to-cyan-600 dark:from-violet-400 dark:to-cyan-400">
                            Autonomous Future
                        </span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="group relative p-10 rounded-3xl bg-white/70 dark:bg-black/60 border border-slate-200 dark:border-white/10 hover:border-violet-500/40 overflow-hidden transition-all duration-500 hover:shadow-2xl">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                            <Target className="w-40 h-40 text-violet-600 dark:text-violet-400" />
                        </div>
                        <div className="w-14 h-14 bg-linear-to-br from-violet-600 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-violet-500/20">
                    ...
                    <div className="group relative p-10 rounded-3xl bg-white/70 dark:bg-black/60 border border-slate-200 dark:border-white/10 hover:border-cyan-500/40 overflow-hidden transition-all duration-500 hover:shadow-2xl">
                        <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                            <Eye className="w-40 h-40 text-cyan-600 dark:text-cyan-400" />
                        </div>
                        <div className="w-14 h-14 bg-linear-to-br from-cyan-600 to-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-cyan-500/20">
                ...
                {storyTitle && storyContent && (
                    <div className="mb-16 p-10 rounded-3xl bg-white/70 dark:bg-black/60 border border-slate-200 dark:border-white/10 transition-colors duration-700">
                ...
                <div className="bg-linear-to-br from-violet-600/10 via-transparent to-cyan-600/10 dark:from-violet-900/30 dark:to-cyan-900/30 rounded-3xl border border-white/50 dark:border-white/10 p-16 text-center relative overflow-hidden transition-colors duration-700">
