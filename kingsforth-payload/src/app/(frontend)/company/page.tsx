...
export default async function CompanyPage() {
    return (
        <div className="min-h-screen text-foreground relative z-10 pt-32 pb-24">
            <div className="max-w-4xl mx-auto text-center space-y-8 p-10 bg-white/70 dark:bg-black/75 rounded-3xl shadow-2xl border border-white/50 dark:border-white/10 transition-colors duration-700 mb-20 relative z-10">
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter text-slate-900 dark:text-white mb-6 transition-colors duration-700">
                    About <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-600 to-cyan-600 dark:from-violet-400 dark:to-cyan-400">Kingsforth</span>
                </h1>
            ...
            <div className="max-w-350 mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                <div className="bg-white/70 dark:bg-[#08080C]/80 border border-slate-200 dark:border-white/10 rounded-3xl p-10 text-center hover:-translate-y-2 transition-all duration-500 shadow-xl">
