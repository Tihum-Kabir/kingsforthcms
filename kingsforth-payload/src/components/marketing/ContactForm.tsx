...
export function ContactForm() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto bg-white/60 dark:bg-white/[0.04] backdrop-blur-xl border border-white/80 dark:border-white/10 rounded-2xl p-8 shadow-2xl transition-colors duration-500">
            <h2 className="text-2xl font-bold text-[#111827] dark:text-white mb-6">Send us a message</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full bg-[#f3f4f6]/50 dark:bg-[#0A2240]/50 border border-slate-300 dark:border-white/10 rounded-lg px-4 py-3 text-slate-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
                        />
                    </div>
                    <div className="space-y-2">
