...
export function ServicePricing({ service }: { service: Service }) {
    ...
    const tiers = service.plans;
    const hasBothPeriods = tiers.some((tier: any) => true);
        ...
        <section className="py-32 px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="max-w-350 mx-auto relative z-10">
                ...
                <motion.div
                    ...
                    whileInView="show"
                    viewport={{ once: true }}
                    className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-350 mx-auto"
                >
