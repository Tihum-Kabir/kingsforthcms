...
export const INDUSTRY_SOLUTIONS: StaticSolution[] = [
  {
    slug: 'education',
    title: 'Education',
    ...
    accentColor: 'violet',
    shortDescription:
      'K-12 schools and higher education institutions face uniquely complex security environments. Kingsforth delivers purpose-built AI surveillance, automated emergency response, and forensic intelligence for academic campuses.',
...
Kingsforth's Education solution resolves this tension. Our AI-powered platform monitors your campus continuously without the intrusion of constant human security presence. Behavioral detection algorithms identify threats at the moment they emerge, before they escalate. Automated response protocols execute emergency procedures in seconds. And privacy-by-default design ensures student and faculty privacy is protected throughout.

Whether you are securing a single K-12 campus or a distributed university system, Kingsforth's platform scales to your environment and integrates with your existing camera infrastructure — no hardware replacement required.`,
    stats: [
    ...
    featureSections: [
      {
        ...
        description:
          "Kingsforth's Cognitive Surveillance engine continuously analyzes video feeds from your campus cameras — detecting the behavioral signals that precede incidents before they become emergencies.",
        points: [
      ...
      },
      {
        ...
        points: [
          ...
          'Person-of-interest watchlist integration',
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Kingsforth's Cognitive Surveillance engine integrates with virtually any IP camera system via RTSP/ONVIF protocols. There is no need to replace existing hardware. Our edge appliances are installed alongside your current VMS, adding AI analysis capability without disrupting existing recording and monitoring workflows.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Emergency protocols are configured collaboratively with your security administrators and school leadership using Kingsforth's visual protocol builder. Every protocol is reviewed, approved, and test-executed in simulation mode before going live. Annual protocol reviews and fire drill integrations are standard. No automated action occurs without prior administrator approval of the protocol.",
      },
      {
        question: 'Is special pricing available for public schools?',
        answer:
          "Yes. Kingsforth offers dedicated pricing structures for public K-12 institutions, including grant-eligible configurations and phased deployment options that align with typical school budget cycles. Contact us to discuss your institution's specific budget context and requirements.",
      },
    ],
  },
...
Kingsforth's Corporate solution is built for this complexity. Our platform unifies security intelligence across your entire enterprise estate — every camera, every sensor, every access point — into a single operational picture. Threats are detected before they escalate. Responses are automated to eliminate the delay between detection and action. Historical data becomes instantly searchable when incidents require investigation.

For senior security leadership, Kingsforth delivers something previously impossible: genuine operational visibility across a distributed enterprise, with the intelligence to act proactively rather than reactively.`,
    stats: [
...
Kingsforth's Cities & Government solution is engineered for this operating environment. Our platform has been designed with sovereignty, data governance, and public accountability as foundational requirements — not afterthoughts. AI capabilities are deployed to enhance, not replace, public safety decision-making.

From smart city surveillance infrastructure to critical facility protection to emergency response coordination, Kingsforth provides the intelligence layer that enables government agencies to fulfill their public safety mandate with the resources available.`,
    stats: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Kingsforth integrates with CAD (Computer-Aided Dispatch) systems through standard law enforcement integration protocols including NIEM conformant APIs. Emergency alerts from the platform can populate directly into CAD systems with location data, incident type, and visual context.",
      },
    ],
  },
];

export const USECASE_SOLUTIONS: StaticSolution[] = [
  {
...
Kingsforth's Medical Emergency detection capability uses behavioral AI to identify the visual signatures of medical events — sudden falls, collapse, loss of mobility, and distress behavior — across your facility camera network. When a potential medical event is detected, alerts are dispatched immediately with location data and visual context, enabling response before someone calls for help.`,
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Camera monitoring in bathrooms or private offices is not appropriate and Kingsforth does not configure this. For bathrooms and other private spaces where monitoring is not possible, lone worker wellness check protocols can be configured — periodic automated check-ins where no response triggers an alert to a duty supervisor.",
      },
      {
...

  {
    ...
    longDescription: `The difference between effective violence prevention and reactive response is measured in seconds. Kingsforth's Weapons & Violence Detection capability continuously analyzes your security camera feeds for the visual signatures of weapons and violent behavior — detecting threats the moment they become visible, before they escalate to their maximum potential harm.
...
Kingsforth's VSOC Integration transforms your security operations by connecting every component of your security ecosystem — AI surveillance feeds, access control systems, IoT sensors, incident management tools, and physical response assets — into a single, unified command platform. Your security team operates with complete situational awareness, automated workflow support, and direct command of physical response systems.`,
    stats: [
    ...
    featureSections: [
      ...
      },
      {
        ...
        description:
          "Kingsforth's VSOC platform is designed to be the integration hub for your security ecosystem — not a closed system that creates new silos.",
        points: [
...
export const ALL_SOLUTIONS: StaticSolution[] = [...INDUSTRY_SOLUTIONS, ...USECASE_SOLUTIONS];

export function getSolutionBySlug(slug: string): StaticSolution | undefined {
